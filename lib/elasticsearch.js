...
var es_bulk_insert = function elasticsearch_bulk_insert(listCounters, listTimers, listTimerData, listGaugeData) {
      ...
      for (key in listCounters) {
        payload += '{"index":{"_index":"'+"counter-"+statsdIndex+'"}}'+"\n";
        payload += '{';
        innerPayload = '';
      ...
      for (key in listTimers) {
        payload += '{"index":{"_index":"'+"timer-"+statsdIndex+'"}}'+"\n";
        payload += '{';
        innerPayload = '';
      ...
      for (key in listTimerData) {
        payload += '{"index":{"_index":"'+"timerdata-"+statsdIndex+'"}}'+"\n";
        payload += '{';
        innerPayload = '';
      ...
      for (key in listGaugeData) {
        payload += '{"index":{"_index":"'+"gauge-"+statsdIndex+'"}}'+"\n";
        payload += '{';
        innerPayload = '';
